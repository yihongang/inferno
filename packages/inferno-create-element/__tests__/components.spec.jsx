...
// 				render(<Comp1 foo={true}/>, container);
// 			} catch (e) {
// 				expect(e.message).to.eql('Inferno Error: a valid Inferno IVNode (or null) must be returned from a component render. You may have returned an array or an invalid object.');
// 			}
//
// 			expect(container.innerHTML).to.eql('<div>rendered</div>');
// 		});
...
// 			render() {
// 				if (this.state.n) {
// 					return <em onClick={this.onClick}>EM</em>;
// 				}
// 				return <span onClick={this.onClick}>SPAN</span>;
// 			}
// 		}
