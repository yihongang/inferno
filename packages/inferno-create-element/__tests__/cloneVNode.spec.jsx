...
// 		expect(container.innerHTML).toEqual(innerHTML('<a></a>'));
// 	});
//
...
// 		render(node, container);
// 		expect(container.innerHTML).toEqual(innerHTML('<div><a>1</a></div>'));
// 	});
//
...
// 		expect(container.innerHTML).toEqual(innerHTML('<div><span>arr2b</span></div>'));
//
...
// 		expect(container.innerHTML).toEqual(innerHTML('<div><span>arr3b</span></div>'));
// 	});
//
...
// 		render(node, container);
// 		expect(container.innerHTML).toEqual(innerHTML('<div><span>arr3a</span><span>arr3b</span><span>arr3c</span></div>'));
// 	});
//
...
// 		render(node, container);
// 		expect(container.innerHTML).toEqual(innerHTML('<div><span>arr3a</span></div>'));
// 	});
//
...
// 		render(node2, container);
// 		expect(container.innerHTML).toEqual(innerHTML('<div>Hello world 2!</div>'));
//
// 		const node3 = cloneVNode(node2, { className: 'foo' }, 'Hello world 2!');
// 		render(node3, container);
// 		expect(container.innerHTML).toEqual(innerHTML('<div class="foo">Hello world 2!</div>'));
//
// 		const node4 = cloneVNode(node1, { className: 'foo' }, 'Hello world 3!');
// 		render(node4, container);
// 		expect(container.innerHTML).toEqual(innerHTML('<div class="foo">Hello world 3!</div>'));
// 	});
//
...
//
// 		render(node3, container);
// 		expect(container.innerHTML).toEqual(innerHTML('<div class="yo">Hello world 3!</div>'));
// 	});
//
...
//
// 		expect(container.innerHTML).toEqual('<div>Second</div>');
//
// 		render(cloneVNode(nodeToClone, { children: 'Second' }, 'Third'), container);
//
// 		expect(container.innerHTML).toEqual('<div>Third</div>');
//
// 		render(cloneVNode(nodeToClone, { children: 'Second' }, 'Third', 'Fourth'), container);
//
// 		expect(container.innerHTML).toEqual('<div>ThirdFourth</div>');
// 	});
//
