...
// 		expect(ConnectedComponent.WrappedComponent).toEqual(BasicComponent);
// 	});
//
...
// 		});
// 		store.dispatch({ type: '' });
// 		expect(container.innerHTML).toEqual(innerHTML('<a>1</a>'));
// 		container.querySelector('a').click();
// 		setTimeout(() => {
// 			expect(container.innerHTML).toEqual(innerHTML('<a>2</a>'));
// 			done();
// 		}, 10);
// 	});
//
...
// 		expect(container.innerHTML).toEqual(innerHTML('<div>dispatch state parent</div>'));
// 	});
// });
